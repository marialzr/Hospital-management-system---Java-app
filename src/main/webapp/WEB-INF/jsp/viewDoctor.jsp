...
<table>
    <tr>
		...
		<form:form commandName="doctor" cssClass="form-horizontal" method="POST">
			<div class="form-group">
				<label for="did" class="col-sm-3 control-label">Doctor Id</label>
				<div class="col-sm-5">
					<form:input path="did" cssClass="form-control" placeholder="Doctor Id"/>
				</div>
			</div>
...
<table>
    ...
    <c:forEach items="${doctors}" var="doc" varStatus="status">
        <tr>
            <td>${doc.did}</td>
            <td>${doc.firstName}</td>
           <td>
           <form:form action="/doctors/view/${doc.did}" method="GET">
    		<input type="submit" value="View" />
		   </form:form>
		   </td>
		   <td>
		   <form:form action="/doctors/delete/${doc.did}" method="GET">
    		<input type="submit" value="Delete" />
		   </form:form>
		   </td>
		   <td>
		   <form:form action="/doctors/update/${doc.did}" method="GET">
